...
extern const u8 BattleScript_AspectPreventsOHKO[];
extern const u8 BattleScript_DampStopsExplosion[];
extern const u8 BattleScript_MoveHPDrain[];
extern const u8 BattleScript_AspectMoveHPDrain[];
extern const u8 BattleScript_MonMadeMoveUseless[];
extern const u8 BattleScript_MonAspectMadeMoveUseless[];
...
extern const u8 BattleScript_SturdiedAspectMsg[];

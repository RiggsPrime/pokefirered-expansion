...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNPROTECTEDBYASPECT]                = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was protected by its aspect!"),
    ...
    [STRINGID_PKMNRESTOREDHPUSINGASPECT]            = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} restored HP using its aspect!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNSASPECTMADEYUSELESS]              = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s aspect made {B_CURRENT_MOVE} useless!"),
    ...
    [STRINGID_ENDUREDSTURDYASPECT]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} endured the hit using its aspect!"),

...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_CHARMANDER] =
    {
        ...
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_NONE, ABILITY_SOLAR_POWER },
        .aspect = ASPECT_CHARMANDER,
